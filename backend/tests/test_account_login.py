...
def test_login_invalid_email_returns_400(client, fake_users):
    response = client.post(
        "/account/login", json={"email": "testexample.com", "password": "correct-password"}
    )
...
def test_login_unknown_user_returns_404(client, fake_users):
    response = client.post(
        "/account/login", json={"email": "test@example.com", "password": "secret123"}
    )
...
def test_login_wrong_password_returns_401(client, fake_users):
    ...
    response = client.post(
        "/account/login", json={"email": "test@gmail.com", "password": "wrong-password"}
    )
...
def test_login_unverified_user_returns_404(client, fake_users):
    ...
    response = client.post(
        "/account/login", json={"email": "test@gmail.com", "password": "correct-password"}
    )
...
def test_login_success_returns_200(client, fake_users):
    ...
    response = client.post(
        "/account/login",
        json={"email": "test@gmail.com", "password": "correct-password", "remember": False},
    )
...
def test_login_success_remember_returns_200(client, fake_users):
    ...
    response = client.post(
        "/account/login",
        json={"email": "test@gmail.com", "password": "correct-password", "remember": True},
    )
